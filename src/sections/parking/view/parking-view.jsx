...
export default function ParkingData() {
  ...
  const getUsersData = async () => {
    ...
    try {
      const response = await axios.get(`${baseUrl}post-property/get-parking-data`, {
        headers: {
          Authorization: token,
        },
      });
  ...
  const handleFormSubmit = async (newData) => {
    try {
      ...
      await axios.post(
        `${baseUrl}post-property/create-parkings`,
      ...
      getUsersData();
      setSnackbarMessage('Parking data added successfully');
