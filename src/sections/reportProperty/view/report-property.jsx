...
export default function ReportPropertyPage() {
  ...
  const getUsersData = async () => {
    ...
    try {
      const response = await axios.get(`${baseUrl}post-property/get-reports-property`, {
        headers: {
          Authorization: token,
        },
      });
  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h4">Report Property List</Typography>
      </Stack>
            ...
            <Table sx={{ minWidth: 800 }}>
              <UserTableHead
                ...
                headLabel={[
                  ...
                  { id: 'propertyType', label: 'propertyType' },
                  { id: 'propertyCreated', label: 'Proerty Created by' },
                ]}
              />
              <TableBody>
                  ...
                  dataFiltered
                    ...
                    .map((row) => (
                      <UserTableRow
                        ...
                        propertyType={row.propertyId.requestData.postType}
                        propertyCreated={row.propertyId.userId.name}
                        _id={row._id}
