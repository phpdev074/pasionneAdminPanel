...
export default function PgAminitiesData() {
  ...
  const getUsersData = async () => {
    ...
    try {
      const response = await axios.get(`${baseUrl}post-property/get-pg-aminities-data`, {
        headers: {
          Authorization: token,
        },
      });
  ...
  const handleFormSubmit = async (newData) => {
    try {
      ...
      await axios.post(
        `${baseUrl}post-property/create-pg-aminities`,
  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        <Typography variant="h4">PG Aminities</Typography>
