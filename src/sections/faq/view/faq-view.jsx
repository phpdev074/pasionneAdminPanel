...
export default function FaqView() {
  ...
  const getUsersData = async () => {
    ...
    try {
      const response = await axios.get(`https://pasionneapi.codingacademy.world/api/testimonial/get-faqs`);
  ...
  const handleFormSubmit = async (newData) => {
    try {
      ...
      await axios.post(
        `${baseUrl}testimonial/create-faq`,
        { question:newData.question,answer:newData.answer },
      );
      getUsersData(); 
